      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative flex flex-col gap-8 p-8 md:flex-row md:items-center md:justify-between">
            ...
            <Button size="lg" variant="secondary" className="shrink-0 gap-2 rounded-full bg-white text-[var(--foreground)] hover:bg-white/90">
          ...
          {LESSON_KEYS.map((lessonKey, index) => {
            ...
            return (
              ...
              >
                ...
                <Button variant="ghost" className="mt-4 w-full justify-between rounded-xl px-0 text-[var(--primary)] hover:bg-transparent hover:underline">
                  {t("courseCta")}
